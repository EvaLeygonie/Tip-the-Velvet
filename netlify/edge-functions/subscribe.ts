            ...
            <td style="padding: 40px 30px;">
              ...
              <div style="color: #e2dada; font-size: 15px; line-height: 1.6; font-weight: 300;">
                ${
                  isSv
                    ? `
                  <p style="margin-bottom: 20px;">Tack för att du prnumererar på <strong>Tip the Velvet</strong>s nyhetsbrev. Vad roligt att du vill få uppdateringar om event och annat roligt från oss!</p>
                  <p style="margin-bottom: 20px;">Du kan alltid avsluta din prenumeration via "avregistrera" länken i dom kommande mail.</p>
                `
                    : `
