...
export const Dresscode = () => {
  ...
  return (
    <div className="layout-base bg-background selection:bg-accent/30">
      <div className="page-standard">
        <div className="bg-glow-spot top-10 left-1/2 -translate-x-1/2" />

        {/* Header Section */}
        <header className="space-y-4 mb-16 text-center relative z-10">
          <span className="text-[11px] uppercase tracking-[0.25em] text-accent/90 font-body block animate-pulse">
            ✦ {t('Hur vi klär oss', 'How we dress')} ✦
          </span>
          <h1>Dresscode</h1>
          <div className="flex justify-center pt-2">
            <div className="gold-divider" />
          </div>
          <p className="subtitle max-w-2xl mx-auto text-lg md:text-xl py-4">
            {t(
          ...
          <div className="max-w-4xl mx-auto text-center space-y-6">
            {/* Fixat textkontrast från text-info till text-foreground samt tagit bort "JavaScript-" felskrivningen */}
            <p className="text-foreground text-base md:text-lg leading-relaxed not-italic text-center font-body">
              {t(
