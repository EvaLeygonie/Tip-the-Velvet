      ...
      <div className="page-shell">
        <header className="header !mb-0 !pb-5">
          ...
          <p className="text-accent font-heading font-medium tracking-wide text-base md:text-xl  max-w-2xl mx-auto">
            {t(
              'Kontaktuppgifter delas såklart inte till publiken och samlas endast i syfte av enklare framtida samarbeten! Om du har frågor, maila oss gärna på: ',
